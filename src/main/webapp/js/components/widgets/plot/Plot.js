...
define(function (require) {
    ...
    var StateVariablePlot = require('./StateVariablePlot');
	...
	return Widget.View.extend({
		...
		initialize: function (options) {
		    ...
		    this.plotOptions = this.defaultOptions();
                        // by default assume state variable plot
                        this.dataAtStep = StateVariablePlot.dataAtStep;
			this.labelsMap = {};
		...
		getTimeSeriesData: function (instanceY, instanceX, step) {
		    var timeSeriesX = instanceX.getTimeSeries().slice(0,step);
		    var timeSeriesY = instanceY.getTimeSeries().slice(0,step);
		    var timeSeriesData = {};
                    
		    timeSeriesData.x = timeSeriesX;
		    timeSeriesData.y = timeSeriesY;
	     ...
	     */
            updateDataSet: function(step, playAll) {
                // make copy of data because this.datasets is overwritten
                if (typeof this.totalDatasets === 'undefined') {
                    this.totalDatasets = [];
