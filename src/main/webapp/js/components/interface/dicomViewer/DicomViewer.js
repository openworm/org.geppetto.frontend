	...
	var dicomViewerComponent = React.createClass({
		...
		componentDidMount: function () {
			...
			function init() {
				...
				// renderer
				threeD = document.getElementById('dicomViewer');
				threeD.style.height = "300px";
				threeD.style.width = "350px";
			...
			function buildGUI(stackHelper) {
				...
				function onWindowResize() {
					var threeD = document.getElementById('dicomViewer');
					camera.canvas = {
			...
			return (
				<div>
					...
					<div id="my-lut-container">
						<div>CT<div id="my-lut-canvases-l0"></div></div>
						<div>Segmentation<div id="my-lut-canvases-l1"></div></div>
					</div>
				</div>
			)
		}
