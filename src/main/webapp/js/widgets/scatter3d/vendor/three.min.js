...
THREE.AxisHelper = function ( size, colorX, colorY, colorZ ) {
	...
	geometry.colors.push(
		colorX, new THREE.Color().copy(colorX),
		colorY, new THREE.Color().copy(colorY),
		colorZ, new THREE.Color().copy(colorZ)
	);
