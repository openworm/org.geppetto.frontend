...
define(function (require) {
    ...
    link.type = "text/css";
    link.rel = "stylesheet";
    link.href = "geppetto/js/components/widgets/popup/Popup.css";
    document.getElementsByTagName("head")[0].appendChild(link);

	var link = document.createElement("link");
    link.type = "text/css";
    link.rel = "stylesheet";
    link.href = "geppetto/js/components/widgets/popup/vendor/slick.css";
    document.getElementsByTagName("head")[0].appendChild(link);

	var link = document.createElement("link");
    link.type = "text/css";
    link.rel = "stylesheet";
    link.href = "geppetto/js/components/widgets/popup/vendor/slick-theme.css";
    document.getElementsByTagName("head")[0].appendChild(link);
	...
	var popupComponent = React.createClass({
		...
		render: function () {
            return (
                <div key={this.props.id + "_component"} id={this.props.id + "_component"} className="popup">
                </div>
            )
        }
