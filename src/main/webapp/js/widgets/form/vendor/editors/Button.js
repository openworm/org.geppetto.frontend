...
require(['widgets/form/vendor/editors/BootstrapMenuMaker'],function(BootstrapMenuMakers){
...
//		    this.$('input[type=radio]:focus').blur();
		  ...
		  render: function() {
			    this.$el.html(BootstrapMenuMakers.generateToolbar({"buttonGroupOne": this.schema.options}));
